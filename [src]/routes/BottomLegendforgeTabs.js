...
import LegendforgeScreen from '../views/LegendforgeScreen';
import TempleLibrary from '../views/TempleLibrary';
import AmazonsQuiz from '../views/AmazonsQuiz';
import TempleSettingsScreen from '../views/TempleSettingsScreen';
