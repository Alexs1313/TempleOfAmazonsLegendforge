// Templeofamzns quiz screen
import QuizIntro from '../Templeofamznscompnts/QuizIntro';

import AsyncStorage from '@react-native-async-storage/async-storage';
import { quizQuestions } from '../Templeofamznsddta/quizQuestions';
import QuizAnswerButton from '../Templeofamznscompnts/QuizAnswerButton';
  ...
  return (
    ...
    >
      ...
      >
        <View
          style={[
            styles.templeLegendQuizContainer,
            { paddingTop, padding: quizPad },
          ]}
        >
          <View style={styles.templeLegendHeader}>
            <Text style={[styles.templeLegendProgress, { fontSize: progressSize }]}>
          ...
          <View
            style={[
              styles.templeLegendQuestionBox,
              {
          ...
          >
            <Text style={[styles.templeLegendQuestion, { fontSize: questionSize }]}>
              {question?.question}
            </Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  templeLegendProgress: {
    color: '#FFB907',
    fontWeight: '700',
  },
  templeLegendExitButton: {
    backgroundColor: '#251F21',
    justifyContent: 'center',
    alignItems: 'center',
  },
  templeLegendQuestionBox: {
    backgroundColor: '#2B2B2B',
  },
  templeLegendQuestion: {
    color: primWhite,
    textAlign: 'center',
    fontWeight: '500',
  },
